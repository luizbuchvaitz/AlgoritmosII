...
//atribuindo um texto a variável tipo se selecionado
    ...
    private void btnOsAdicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOsAdicionarActionPerformed
        ...
        if ((txtCliId.getText().isEmpty()) || (txtOsEquip.getText().isEmpty()) || (txtOsDef.getText().isEmpty())) {
            ...
            String retornoEmit = osDAO.emitir_os(new OrdemServico(tipo, cboOsSit.getSelectedItem().toString(), txtOsEquip.getText(), txtOsDef.getText(), txtOsServ.getText(), txtOsTec.getText(), Double.parseDouble(txtOsValor.getText().replace(",", "."))), Integer.parseInt(txtCliId.getText()));
            JOptionPane.showMessageDialog(null, retornoEmit);
        }
    ...
    private void btnOsPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOsPesquisarActionPerformed
        ...
        OrdemServico os = osDAO.pesquisar_os(Integer.parseInt(numOS));
    ...
    private void btnOsAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOsAlterarActionPerformed
        ...
        if ((txtCliId.getText().isEmpty()) || (txtOsEquip.getText().isEmpty()) || (txtOsDef.getText().isEmpty())) {
            ...
            String retornoAlter = osDAO.alterar_os(Integer.parseInt(txtOs.getText()), new OrdemServico(tipo, cboOsSit.getSelectedItem().toString(), txtOsEquip.getText(), txtOsDef.getText(), txtOsServ.getText(), txtOsTec.getText(), Double.parseDouble(txtOsValor.getText().replace(",", "."))));
            JOptionPane.showMessageDialog(null, retornoAlter);
        }
    ...
    private void btnOsExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOsExcluirActionPerformed
        int confirma = JOptionPane.showConfirmDialog(null, "Tem certeza que deseja excluir esta OS?", "Atenção", JOptionPane.YES_NO_OPTION);
        if (confirma == JOptionPane.YES_OPTION) {
            String retornoDel = osDAO.excluir_os(Integer.parseInt(txtOs.getText()));
            JOptionPane.showMessageDialog(null, retornoDel);
        }
